<x-guest>
    ...
    <main class="grid grid-cols-4 gap-8 mt-8 wrapper">
        ...
        <section class="flex flex-col col-span-3 gap-y-4">
            <small class="text-sm text-gray-400">Threads>create</small>
                            ...
                            <div class="space-y-8">
                                ...
                                <div>
                                    ...
                                    <select name="category" id="category"
                                        class="w-full text-sm px-3 h-10 border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                ...
                                <div>
                                    ...
                                    <select name="tags[]" id="tags" multiple x-data="{}"
