                            ...
                            <div class="space-y-8">
                                ...
                                <div>
                                    ...
                                    <select name="category" id="category"
                                        class="w-full px-3 h-10 text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
